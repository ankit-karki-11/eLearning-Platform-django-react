...
const Coursedetails = () => {
    ...
    const handleBuyNow = () => {
        if (user) {
            ...
            // navigate('courses/course-detail/:slug/payment/${course.slug}')
            // toast.message("Thank you for your interest.Payment page is developing");
        }
        else {
                    ...
                    <div className="flex-1">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                            ...
                            <div className="grid gap-3">
                                {[/* Add course features here */].map((feature, index) => (
