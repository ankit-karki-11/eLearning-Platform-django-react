      ...
      <div className="p-3 space-y-2">
        ...
        {isEnrolled && (
          <div className="pt-1">
            ...
            <Button
              size="sm"
              className={`w-full mt-2 h-8 text-xs font-medium cursor-pointer ${isCompleted ? 'bg-black hover:bg-gray-950 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-900'
                }`}
