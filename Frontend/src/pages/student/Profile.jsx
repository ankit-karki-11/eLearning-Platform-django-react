                        ...
                        <div className="flex gap-2">
                            <Dialog>
                                <DialogTrigger asChild>
                                    ...
                                    <Button variant="outline" clasName='gap-2'>
                                ...
                                <DialogContent className="sm:max-w-[425px]">
                                    ...
                                    <div className="grid gap-4 py-4">
                                        ...
                                        <div className="grid grid-cols-4 items-center gap-4">
                                            ...
                                            <Input id="name" type="text" placeholder="Enter your name" className="col-span-3" />
                                        </div>
                                        <div className="grid grid-cols-4 items-center gap-4">
                                            <Label htmlFor="phone" className="text-right">
                                                Phone
                                            </Label>
                                            <Input id="phone" placeholder="9812345678" className="col-span-3" />
                                        </div>
                                    </div>
                                    <DialogFooter>
            ...
            <Tabs defaultValue="courses" className="mt-8">
                ...
                <TabsContent value="certificates" className="mt-6 py-8">
                    ...
                    {/* <div className='mt-6 py-8 text-center'>
                        ...
                        {
                            enrolledCourses.lenght===0 ? <h1>
                                You have not enrolled on any course
                            </h1>:(
